...
// Boot envelope payload. Field order pinned per N1:
//   runtime_type        at  0 (1 byte)
//   reserved3           at  1 (3 bytes; zero-pad to align uint32)
//   team_number         at  4 (4 bytes; per fork F1 — moved here from
//                              clock_state because it is session-
//                              invariant; in-tick churn would be a
//                              silent-corruption attractor)
//   vendor_capabilities at  8 (4 bytes)
//   wpilib_version      at 12 (32 bytes)
// sizeof = 44, alignof = 4, no implicit pad.
